  ...
  <div class="mx-auto max-w-7xl px-2 md:px-6 lg:px-8 py-2">
    <div class="relative flex items-center justify-between">
      ...
      <div class="flex flex-row-reverse md:flex-row items-center gap-[5px]">
        <details bind:this={mobileMenu} class="relative ml-3 md:hidden" id="vertnav-mobile-menu">
          <summary
            class={clsx(
        ...
        <a href={GITHUB_REPO_URL} target="_blank" rel="noreferrer" class="nav-button" aria-label="Our Github repo (opens in a new tab)">
