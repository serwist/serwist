...
export const REROUTE: Record<string, string> = {
  ...
  "/docs/next/configuring/disable-precache-manifest": "/docs/build/configuring/disable-precache-manifest",
  "/docs/next/configuring/dont-cache-bust-urls-matching": "/docs/build/configuring/dont-cache-bust-urls-matching",
  "/docs/next/configuring/glob-directory": "/docs/build/configuring/glob-directory",
  "/docs/next/configuring/glob-follow": "/docs/build/configuring/glob-follow",
  "/docs/next/configuring/glob-ignores": "/docs/build/configuring/glob-ignores",
  "/docs/next/configuring/glob-patterns": "/docs/build/configuring/glob-patterns",
  "/docs/next/configuring/glob-strict": "/docs/build/configuring/glob-strict",
  ...
  "/docs/next/configuring/templated-urls": "/docs/build/configuring/templated-urls",
  "/docs/vite/configuring/additional-precache-entries": "/docs/build/configuring/additional-precache-entries",
  "/docs/vite/configuring/disable-precache-manifest": "/docs/build/configuring/disable-precache-manifest",
