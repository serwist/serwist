...
const reorder = (a: SidebarLink, b: SidebarLink) => (a.title < b.title ? -1 : 1);
    ...
    children: [
      { title: "Getting started", href: "/docs/next/getting-started" },
      {
        ...
        children: [
          ...
          { title: "globDirectory", href: "/docs/next/configuring/glob-directory" },
          { title: "globFollow", href: "/docs/next/configuring/glob-follow" },
          { title: "globIgnores", href: "/docs/next/configuring/glob-ignores" },
          { title: "globPatterns", href: "/docs/next/configuring/glob-patterns" },
          { title: "globStrict", href: "/docs/next/configuring/glob-strict" },
          ...
          { title: "templatedURLs", href: "/docs/next/configuring/templated-urls" },
        ],
      },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: "disablePrecacheManifest", href: "/docs/vite/configuring/disable-precache-manifest" },
