...
<h1 id="cache-only">CacheOnly</h1>
<h2 id="first-added">First added</h2>
<p>Workbox</p>
<h2 id="about">About</h2>
<p>
  An implementation of the <ExternalLink class="link" href="https://developer.chrome.com/docs/workbox/caching-strategies-overview/#cache_only">
    cache only
  </ExternalLink> request strategy.
</p>
<p>This class is useful if you already have your own precaching step.</p>
<p>If there is no cache match, this will throw a <ICD>SerwistError</ICD> exception.</p>
...
<p>Here is a list of resources you can read to learn more about <ICD>CacheOnly</ICD>:</p>
<ul class="list">
  <li>
