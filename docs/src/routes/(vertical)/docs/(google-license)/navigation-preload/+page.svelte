...
<p>
  <ICD>@serwist/navigation-preload</ICD> is a module that allows developers to enable navigation preloading in their service worker.
</p>
<p>
  It will check whether navigation preloading is supported in the current browser, and if it is, an <ICD>activate</ICD> event handler will be automatically
