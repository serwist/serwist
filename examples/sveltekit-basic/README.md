# Serwist example - sveltekit-basic
...
```bash
npx degit serwist/serwist/examples/sveltekit-basic my-app
```

```bash
yarn degit serwist/serwist/examples/sveltekit-basic my-app
```

```bash
pnpx degit serwist/serwist/examples/sveltekit-basic my-app
```

```bash
bunx degit serwist/serwist/examples/sveltekit-basic my-app
```
