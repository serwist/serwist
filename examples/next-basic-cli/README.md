# Serwist example - next-basic-cli
...
```bash
npx degit serwist/serwist/examples/next-basic-cli my-app
```

```bash
yarn degit serwist/serwist/examples/next-basic-cli my-app
```

```bash
pnpx degit serwist/serwist/examples/next-basic-cli my-app
```

```bash
bunx degit serwist/serwist/examples/next-basic-cli my-app
```
